...
sudo pip3 install -U numpy==1.12 scipy==1.1.0 grpcio==1.22.1 absl-py py-cpuinfo psutil portpicker grpcio six mock requests gast h5py astor termcolor jupyter
